  ...
  const socialLinks = [
    {
      ...
      platform: "LinkedIn",
      value: "Luca Ruggeri",
      link: "https://www.linkedin.com/in/luca-ruggeri97/",
      color: "#0077b5",
      // Codice SVG semplificato
    ...
    },
    {
      ...
      platform: "GitHub",
      value: "LucaRuggeri5",
      link: "https://github.com/LucaRuggeri5",
      color: "#333",
    ...
    },
    {
      ...
      platform: "Discord",
      value: "rujo1927",
      link: "https://discord.com/users/161533401122340864", 
      color: "#5865F2",
    ...
    },
    {
      id: 4,
      platform: "Email",
      value: "luca.ruggeri5@gmail.com",
      link: "mailto:luca.ruggeri5@gmail.com",
      color: "#ea4335",
    ...
    <section id="contatti" className="contact-container">
      ...
      <div className="contact-grid">
        {socialLinks.map((social) => (
          <a key={social.id} href={social.link} target="_blank" rel="noreferrer" className="social-card" style={{ '--hover-color': social.color }}>
